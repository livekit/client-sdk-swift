...
nonisolated struct Livekit_SignalRequest: Sendable {
  ...
  var storeDataBlobRequest: Livekit_StoreDataBlobRequest {
    get {
      if case .storeDataBlobRequest(let v)? = message {return v}
      return Livekit_StoreDataBlobRequest()
    }
    set {message = .storeDataBlobRequest(newValue)}
  }

  /// Retrieve a stored data blob.
  var getDataBlobRequest: Livekit_GetDataBlobRequest {
    get {
      if case .getDataBlobRequest(let v)? = message {return v}
      return Livekit_GetDataBlobRequest()
    }
    set {message = .getDataBlobRequest(newValue)}
  }
...
nonisolated struct Livekit_SignalResponse: Sendable {
  ...
  var storeDataBlobResponse: Livekit_StoreDataBlobResponse {
    get {
      if case .storeDataBlobResponse(let v)? = message {return v}
      return Livekit_StoreDataBlobResponse()
    }
    set {message = .storeDataBlobResponse(newValue)}
  }

  /// Sent in response to `GetDataBlobRequest`.
  var getDataBlobResponse: Livekit_GetDataBlobResponse {
    get {
      if case .getDataBlobResponse(let v)? = message {return v}
      return Livekit_GetDataBlobResponse()
    }
    set {message = .getDataBlobResponse(newValue)}
  }
...
nonisolated struct Livekit_PublishDataTrackRequest: Sendable {
  ...
  var frameEncoding: Livekit_DataTrackFrameEncoding {
    get {_frameEncoding ?? Livekit_DataTrackFrameEncoding()}
    set {_frameEncoding = newValue}
  }
  /// Returns true if `frameEncoding` has been explicitly set.
  var hasFrameEncoding: Bool {self._frameEncoding != nil}
  /// Clears the value of `frameEncoding`. Subsequent reads from it will return its default value.
  mutating func clearFrameEncoding() {self._frameEncoding = nil}
  ...
  var schema: Livekit_DataTrackSchemaId {
    get {_schema ?? Livekit_DataTrackSchemaId()}
  ...
  fileprivate var _frameEncoding: Livekit_DataTrackFrameEncoding? = nil
  fileprivate var _schema: Livekit_DataTrackSchemaId? = nil
}
...
nonisolated struct Livekit_StoreDataBlobRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  fileprivate var _blob: Livekit_DataBlob? = nil
}

nonisolated struct Livekit_StoreDataBlobResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  fileprivate var _key: Livekit_DataBlobKey? = nil
}

nonisolated struct Livekit_GetDataBlobRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated struct Livekit_GetDataBlobResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated extension Livekit_SignalRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 22: try {
        var v: Livekit_StoreDataBlobRequest?
        var hadOneofValue = false
        if let current = self.message {
          hadOneofValue = true
          if case .storeDataBlobRequest(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.message = .storeDataBlobRequest(v)
        }
      }()
      case 23: try {
        var v: Livekit_GetDataBlobRequest?
        var hadOneofValue = false
        if let current = self.message {
          hadOneofValue = true
          if case .getDataBlobRequest(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.message = .getDataBlobRequest(v)
        }
      }()
      default: break
      }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    case .storeDataBlobRequest?: try {
      guard case .storeDataBlobRequest(let v)? = self.message else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 22)
    }()
    case .getDataBlobRequest?: try {
      guard case .getDataBlobRequest(let v)? = self.message else { preconditionFailure() }
...
nonisolated extension Livekit_SignalResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 30: try {
        var v: Livekit_StoreDataBlobResponse?
        var hadOneofValue = false
        if let current = self.message {
          hadOneofValue = true
          if case .storeDataBlobResponse(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.message = .storeDataBlobResponse(v)
        }
      }()
      case 31: try {
        var v: Livekit_GetDataBlobResponse?
        var hadOneofValue = false
        if let current = self.message {
          hadOneofValue = true
          if case .getDataBlobResponse(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.message = .getDataBlobResponse(v)
        }
      }()
      default: break
      }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    case .storeDataBlobResponse?: try {
      guard case .storeDataBlobResponse(let v)? = self.message else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 30)
    }()
    case .getDataBlobResponse?: try {
      guard case .getDataBlobResponse(let v)? = self.message else { preconditionFailure() }
...
nonisolated extension Livekit_PublishDataTrackRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}pub_handle\0\u{1}name\0\u{1}encryption\0\u{3}frame_encoding\0\u{1}schema\0")
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try { try decoder.decodeSingularMessageField(value: &self._frameEncoding) }()
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._frameEncoding {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 4)
    } }()
  ...
  static func ==(lhs: Livekit_PublishDataTrackRequest, rhs: Livekit_PublishDataTrackRequest) -> Bool {
    ...
    if lhs._frameEncoding != rhs._frameEncoding {return false}
...
nonisolated extension Livekit_StoreDataBlobRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".StoreDataBlobRequest"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}request_id\0\u{1}blob\0")
  ...
  static func ==(lhs: Livekit_StoreDataBlobRequest, rhs: Livekit_StoreDataBlobRequest) -> Bool {
...
nonisolated extension Livekit_StoreDataBlobResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".StoreDataBlobResponse"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}request_id\0\u{1}key\0")
  ...
  static func ==(lhs: Livekit_StoreDataBlobResponse, rhs: Livekit_StoreDataBlobResponse) -> Bool {
    if lhs.requestID != rhs.requestID {return false}
...
nonisolated extension Livekit_GetDataBlobRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".GetDataBlobRequest"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}request_id\0\u{3}participant_identity\0\u{1}key\0")
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularUInt32Field(value: &self.requestID) }()
      case 2: try { try decoder.decodeSingularStringField(value: &self.participantIdentity) }()
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.participantIdentity.isEmpty {
      try visitor.visitSingularStringField(value: self.participantIdentity, fieldNumber: 2)
    }
    try { if let v = self._key {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
    } }()
  ...
  static func ==(lhs: Livekit_GetDataBlobRequest, rhs: Livekit_GetDataBlobRequest) -> Bool {
    if lhs.requestID != rhs.requestID {return false}
...
nonisolated extension Livekit_GetDataBlobResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".GetDataBlobResponse"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}request_id\0\u{1}blob\0")
  ...
  static func ==(lhs: Livekit_GetDataBlobResponse, rhs: Livekit_GetDataBlobResponse) -> Bool {
    if lhs.requestID != rhs.requestID {return false}
    if lhs._blob != rhs._blob {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
nonisolated extension Livekit_RequestResponse.Reason: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0OK\0\u{1}NOT_FOUND\0\u{1}NOT_ALLOWED\0\u{1}LIMIT_EXCEEDED\0\u{1}QUEUED\0\u{1}UNSUPPORTED_TYPE\0\u{1}UNCLASSIFIED_ERROR\0\u{1}INVALID_HANDLE\0\u{1}INVALID_NAME\0\u{1}DUPLICATE_HANDLE\0\u{1}DUPLICATE_NAME\0\u{1}INVALID_REQUEST\0")
}
