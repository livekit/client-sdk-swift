...
let package = Package(
    ...
    dependencies: [
        ...
        // Prototype: locally built debug xcframework from rust-sdks (cargo make swift-package-debug).
        .package(name: "livekit-uniffi-xcframework", path: "/Users/blaze/.supacode/repos/rust-sdks/blaze/telemetry/livekit-uniffi/packages/swift/LiveKitUniFFI"),
