...
struct Livekit_DataMessage {
    ...
    var value: Livekit_DataMessage.OneOf_Value?
    ...
    var binary: Data {
        get {
            if case let .binary(v)? = value { return v }
            return Data()
        }
        ...
        case binary(Data)
            ...
            static func == (lhs: Livekit_DataMessage.OneOf_Value, rhs: Livekit_DataMessage.OneOf_Value) -> Bool {
                ...
                case (.binary, .binary): return {
                        guard case let .binary(l) = lhs, case let .binary(r) = rhs else { preconditionFailure() }
                        return l == r
                    }()
...
extension Livekit_ParticipantInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        if !identity.isEmpty {
            try visitor.visitSingularStringField(value: identity, fieldNumber: 2)
        }
        if state != .joining {
            try visitor.visitSingularEnumField(value: state, fieldNumber: 3)
        }
        if !tracks.isEmpty {
            try visitor.visitRepeatedMessageField(value: tracks, fieldNumber: 4)
        }
        if !metadata.isEmpty {
            try visitor.visitSingularStringField(value: metadata, fieldNumber: 5)
        }
        if joinedAt != 0 {
            try visitor.visitSingularInt64Field(value: joinedAt, fieldNumber: 6)
        }
        try unknownFields.traverse(visitor: &visitor)
    }
...
extension Livekit_TrackInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        if muted != false {
            try visitor.visitSingularBoolField(value: muted, fieldNumber: 4)
        }
        try unknownFields.traverse(visitor: &visitor)
    }
...
extension Livekit_DataMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        case .binary?: try {
                guard case let .binary(v)? = self.value else { preconditionFailure() }
