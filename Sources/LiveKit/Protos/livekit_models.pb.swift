...
struct Livekit_RoomInternal {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var trackEgress: Livekit_AutoTrackEgress {
    get {return _trackEgress ?? Livekit_AutoTrackEgress()}
    set {_trackEgress = newValue}
  }
  /// Returns true if `trackEgress` has been explicitly set.
  var hasTrackEgress: Bool {return self._trackEgress != nil}
  /// Clears the value of `trackEgress`. Subsequent reads from it will return its default value.
  mutating func clearTrackEgress() {self._trackEgress = nil}

  var unknownFields = SwiftProtobuf.UnknownStorage()

  init() {}

  fileprivate var _trackEgress: Livekit_AutoTrackEgress? = nil
}

struct Livekit_AutoTrackEgress {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var filePrefix: String = String()

  var output: Livekit_AutoTrackEgress.OneOf_Output? = nil

  var s3: Livekit_S3Upload {
    get {
      if case .s3(let v)? = output {return v}
      return Livekit_S3Upload()
    }
    set {output = .s3(newValue)}
  }

  var gcp: Livekit_GCPUpload {
    get {
      if case .gcp(let v)? = output {return v}
      return Livekit_GCPUpload()
    }
    set {output = .gcp(newValue)}
  }

  var azure: Livekit_AzureBlobUpload {
    get {
      if case .azure(let v)? = output {return v}
      return Livekit_AzureBlobUpload()
    }
    set {output = .azure(newValue)}
  }

  var unknownFields = SwiftProtobuf.UnknownStorage()

  enum OneOf_Output: Equatable {
    case s3(Livekit_S3Upload)
    case gcp(Livekit_GCPUpload)
    case azure(Livekit_AzureBlobUpload)

  #if !swift(>=4.1)
    static func ==(lhs: Livekit_AutoTrackEgress.OneOf_Output, rhs: Livekit_AutoTrackEgress.OneOf_Output) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
      case (.s3, .s3): return {
        guard case .s3(let l) = lhs, case .s3(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.gcp, .gcp): return {
        guard case .gcp(let l) = lhs, case .gcp(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.azure, .azure): return {
        guard case .azure(let l) = lhs, case .azure(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
...
extension Livekit_RoomInternal: @unchecked Sendable {}
extension Livekit_AutoTrackEgress: @unchecked Sendable {}
extension Livekit_AutoTrackEgress.OneOf_Output: @unchecked Sendable {}
...
extension Livekit_RoomInternal: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".RoomInternal"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "track_egress"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularMessageField(value: &self._trackEgress) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._trackEgress {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
    } }()
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: Livekit_RoomInternal, rhs: Livekit_RoomInternal) -> Bool {
    if lhs._trackEgress != rhs._trackEgress {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Livekit_AutoTrackEgress: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".AutoTrackEgress"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "file_prefix"),
    2: .same(proto: "s3"),
    3: .same(proto: "gcp"),
    4: .same(proto: "azure"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self.filePrefix) }()
      case 2: try {
        var v: Livekit_S3Upload?
      ...
      case 3: try {
        var v: Livekit_GCPUpload?
        var hadOneofValue = false
        if let current = self.output {
          hadOneofValue = true
          if case .gcp(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
      ...
      case 4: try {
        var v: Livekit_AzureBlobUpload?
        var hadOneofValue = false
        if let current = self.output {
          hadOneofValue = true
          if case .azure(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.filePrefix.isEmpty {
      try visitor.visitSingularStringField(value: self.filePrefix, fieldNumber: 1)
    }
    switch self.output {
    case .s3?: try {
      guard case .s3(let v)? = self.output else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
    }()
    case .gcp?: try {
      guard case .gcp(let v)? = self.output else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
    }()
    case .azure?: try {
      guard case .azure(let v)? = self.output else { preconditionFailure() }
  ...
  static func ==(lhs: Livekit_AutoTrackEgress, rhs: Livekit_AutoTrackEgress) -> Bool {
