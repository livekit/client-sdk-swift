...
public extension CameraCapturer {
    ...
    var minZoomFactor: CGFloat? { _cameraCapturerState.device?.minAvailableVideoZoomFactor }

    var maxZoomFactor: CGFloat? { _cameraCapturerState.device?.maxAvailableVideoZoomFactor }
}
#endif
