...
internal protocol SignalClientDelegate: AnyObject {
    ...
    func signalClient(_ signalClient: SignalClient, didUpdate trackSid: String, subscribedQualities: [Livekit_SubscribedQuality], subscribedCodecs: [Livekit_SubscribedCodec])
...
//    func signalClient(_ signalClient: SignalClient, didUpdate trackSid: String, subscribedQualities: [Livekit_SubscribedQuality], subscribedCodecs: [Livekit_SubscribedCodec]) -> Bool { false }
