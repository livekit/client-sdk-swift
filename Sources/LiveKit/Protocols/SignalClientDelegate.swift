...
protocol SignalClientDelegate: AnyObject {
    ...
    func signalClient(_ signalClient: SignalClient, didUpdateRemoteMute trackSid: Track.Sid, muted: Bool)
    ...
    func signalClient(_ signalClient: SignalClient, didSubscribeTrack trackSid: Track.Sid)
}
