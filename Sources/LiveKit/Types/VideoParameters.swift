...
extension Collection<VideoParameters> {
                              ...
                              videoEncoding: VideoEncoding? = nil) -> Int
    {
        if isEmpty {
            ...
            globalLogger.log("isEmpty", .error, type: (any Collection).self)
        }

        if dimensions == nil, videoEncoding == nil {
            globalLogger.log("dimensions or videoEncoding parameter is required", .error, type: (any Collection).self)
        }
